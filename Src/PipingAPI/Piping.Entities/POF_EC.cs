...
{
    [Table("TBL_POF_EC")]
    public class POF_EC : Entity
    {
        [Column("TBL_POF_EC_ID")]
        [Key]
        ...
        [Column("SOIL_INTERFACE_CONDENSATION", Order = 44)]
        [MaxLength(1, ErrorMessage = "Length must be 1 character")]
        public string SOIL_INTERFACE_CONDENSATION { get; set; }

        [Column("PIPE_DIRECT_BEAM_COMPLEX_DESIGN", Order = 42)]
        [MaxLength(1, ErrorMessage = "Length must be 1 character")]
        public string PIPE_DIRECT_BEAM_COMPLEX_DESIGN { get; set; }

        [Column("REPAINTED_YEAR", Order = 43)]
        public int? REPAINTED_YEAR { get; set; }

        [Column("EC_DRIVER", Order = 44)]
        [MaxLength(1, ErrorMessage = "Length must be 1 character")]
        public string EC_DRIVER { get; set; }

        [Column("COATING_QUALITY", Order = 44)]
        [MaxLength(1, ErrorMessage = "Length must be 1 character")]
        public string COATING_QUALITY { get; set; }

        [Column("COATING_AGE", Order = 43)]
        public int? COATING_AGE { get; set; }

        [Column("COAT_ADJUSTMENT", Order = 43)]
        public int? COAT_ADJUSTMENT { get; set; }

        [Column("LINE_AGE", Order = 45)]
        public int? LINE_AGE { get; set; }       

        [Column("EXTERNAL_PROCESS", Order = 47)]
